 ...
 */
export function leesClientRateConfig(env = process.env) {
 ...
 */
export function normaliseerIpSleutel(ip) {
...
export function maakRateLimiter(opts) {
    ...
    function evictOudste() {
        ...
        if (oudsteSleutel !== undefined)
            emmers.delete(oudsteSleutel);
    }
