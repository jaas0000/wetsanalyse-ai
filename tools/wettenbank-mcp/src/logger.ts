...
export interface LogVelden {
  [veld: string]: unknown;
}

const NIVEAUS: Record<LogNiveau, number> = {
  debug: 10,
  info: 20,
  warn: 30,
  error: 40,
