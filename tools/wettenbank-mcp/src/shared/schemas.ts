...
const peildatumSchema = z
  ...
  .default(vandaag)
  .describe(
    "Datum YYYY-MM-DD waarop de regeling geldig moet zijn; default is vandaag (Europe/Amsterdam)."
  );
...
export const ZoektermInputSchema = z.object({
  ...
  includeerTekst: z
    ...
    .default(false)
    .describe(
      "Voeg de artikeltekst toe aan elk resultaat. Bespaart een extra wettenbank_artikel-aanroep."
    ),
});
...
export const StructuurInputSchema = z.object({
  ...
  diepte: z
    ...
    .optional()
    .describe(
      "Beperk de boom tot dit aantal niveaus; afgekapte secties krijgen ingekort=true. " +
  ...
  sectie: z
    ...
    .optional()
    .describe(
      "Toon alleen de sectie(s) met dit nummer of deze titel (bv. 'II' of 'Invordering')."
    ),
});
