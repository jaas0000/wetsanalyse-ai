            ...
            <Card key={item.id} className="p-4">
              <div className="flex flex-wrap items-center gap-3">
                ...
                <button
                  ...
                  className="-mr-2 inline-flex min-h-[32px] items-center rounded-kaart px-2 text-xs text-fout opacity-60 transition-opacity hover:opacity-100 disabled:cursor-not-allowed coarse:min-h-[44px]"
                >
